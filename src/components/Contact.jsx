...
export default function Contact() {
  return (
    <section id="contact" className="mx-auto w-full max-w-7xl px-6 pb-20">
      <div className="text-center">
        <h2 className="text-3xl font-semibold text-white">Contact me</h2>
        <p className="mt-2 text-base text-slate-400">
          Reach out and let us build something together.
        </p>
      </div>
      <div className="mt-8 grid gap-6 md:grid-cols-[1.1fr_0.9fr]">
        <div className="contact-card">
          <div className="grid gap-4 md:grid-cols-2">
            ...
            <input className="input md:col-span-2" placeholder="Timeline" />
            <textarea className="input md:col-span-2" rows="4" placeholder="Project details..." />
          </div>
          <button className="btn-outline mt-5" type="button">
            Send
          </button>
        </div>
        ...
        <div className="contact-card">
          <div className="text-center text-sm text-slate-300">
            <img className="logo-img mx-auto" src={logo} alt="Logo" />
            <div className="mt-4 flex justify-center gap-3">
              <a
                className="circle-icon inline-flex items-center justify-center"
            ...
            <div className="mt-4 space-y-2 text-xl text-slate-400">
              <p>walidayoub14@email.com</p>
              <p>+961 81 905 615</p>
            </div>
            <p className="mt-6 text-[16px] text-slate-600">
              Designed by Walid Ayoub
            </p>
          </div>
        </div>
      </div>

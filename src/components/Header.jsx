  ...
  return (
    <header className="sticky top-0 z-20 border-b border-slate-800/60 bg-obsidian/90 backdrop-blur">
      <div className="mx-auto flex w-full max-w-7xl items-center justify-between gap-4 px-6 py-5">
        ...
        <button
          className="inline-flex items-center justify-center rounded-md border border-slate-700/60 px-3 py-2 text-slate-200 transition hover:bg-slate-800/40 md:hidden"
          type="button"
        ...
        >
          ...
          <span className={`font-mono text-sm font-semibold ${isOpen ? 'hidden' : 'block'}`}>
            &lt; &gt;
          </span>
